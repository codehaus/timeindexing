 ...
 * The data is parsed as a Ftp log file, and it
 * expects to see dates of the following format: Fri Jan 17 15:12:18 2003
 */
public class FtpServerLogLine extends Line {
    // the raw regexp
    String pattern = null;
    // the compiled regexp
     ...
     */
    public FtpServerLogLine(InputStream inStream) {
	super(inStream);
     ...
     */
    public FtpServerLogLine(Reader inReader) {
	super(inReader);
	init();
    }
     ...
     */
    public FtpServerLogLine(BufferedReader inReader) {
	super(inReader);
	init();
    }
	...
	// The regexp pattern for Jan 17 15:12:18 2003
	pattern = "[A-Z][a-z][a-z] [\\d ]\\d \\d\\d:\\d\\d:\\d\\d \\d\\d\\d\\d";
