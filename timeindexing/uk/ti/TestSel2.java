...
public class TestSel2 {
	...
	try {
	    ...
	    IndexView narrow1 = index.select(new MidPointInterval(new AbsolutePosition(55), new AbsolutePosition(55),
	    ...
	    IndexView narrow2 = narrow1.select(new MidPointInterval(new AbsolutePosition(10), new AbsolutePosition(10),
	    ...
	    IndexView narrow3 = narrow1.select(new MidPointInterval(new AbsolutePosition(10), new AbsolutePosition(10),
	    ...
	    IndexView narrow4 = narrow1.select(new MidPointInterval(new AbsolutePosition(10), new AbsolutePosition(10),
	    ...
	    IndexView narrow5 = narrow1.select(new MidPointInterval(new AbsolutePosition(10), new AbsolutePosition(10),
	    ...
	    IndexView narrow6 = narrow1.select(new MidPointInterval(new MillisecondTimestamp(10, 900000000), new MillisecondTimestamp(10, 900000000),
								    new Second(2, TimeDirection.FORWARD)),
					       IndexTimestampSelector.DATA, Overlap.FREE,
					       Lifetime.DISCRETE);
	    ...
	    IndexView narrow7 = narrow1.select(new MidPointInterval(new MillisecondTimestamp(10, 900000000), new MillisecondTimestamp(10, 900000000),
								    new AbsolutePosition(30)),
					       IndexTimestampSelector.DATA, Overlap.FREE,
					       Lifetime.DISCRETE);
	    ...
	    IndexView narrow8 = narrow1.select(new MidPointInterval(new MillisecondTimestamp(10, 900000000), new MillisecondTimestamp(10, 900000000),
								    new RelativeCount(10)),
					       IndexTimestampSelector.DATA, Overlap.FREE,
					       Lifetime.DISCRETE);
	    ...
	    IndexView narrow9 = narrow1.select(new MidPointInterval(new MillisecondTimestamp(10, 900000000),  new MillisecondTimestamp(10, 900000000),
								    new ElapsedSecondTimestamp(2)),
					       IndexTimestampSelector.DATA, Overlap.FREE,
					       Lifetime.DISCRETE);
